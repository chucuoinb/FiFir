...
public class ItemListviewConversation {
    private int id;
    private String nameConservation;
    private ArrayList<Friend> listFriends;

    public ItemListviewConversation() {
    }
    ...
    public ItemListviewConversation(String nameConservation, ArrayList<Friend> friends, int id) {
        this.id = id;
