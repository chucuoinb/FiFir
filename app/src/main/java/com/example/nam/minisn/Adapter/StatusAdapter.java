                                ...
                                try {
                                    ...
                                    if (response.getInt(Const.CODE) == Const.CODE_FAIL)
                                        ...
                                        if (response.getInt(Const.CODE) != Const.CODE_OK) {
                                            ...
                                            int typeLike = 0;
                                            if (FragmentStatus.getData().get(position).getTypeLike() == Const.STA_LIKE) {
                                                typeLike = Const.STA_UNLIKE;
                                                int numLike = FragmentStatus.getData().get(position).getCountLike();
                                                if (numLike > 1)
                                                    FragmentStatus.getData().get(position).setCountLike(numLike - 1);
                                                else
                                                    FragmentStatus.getData().get(position).setCountLike(0);
                                            } else {
